...
import com.example.android.tflitecamerademo.RouteGuideGrpc.RouteGuideBlockingStub;
import com.example.android.tflitecamerademo.RouteGuideGrpc.RouteGuideStub;
...
public class RouteGuideActivity extends Activity {
    ...
    private static class GetFeatureRunnable implements GrpcRunnable {
        ...
        public String run(RouteGuideBlockingStub blockingStub, RouteGuideStub asyncStub)
                throws Exception {
            return getFeature(410248224, -747127767, blockingStub);
        }
